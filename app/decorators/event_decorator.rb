class EventDecorator < ApplicationDecorator
  ...
  def about_section
    ...
    best_in_place model, :about, :type => :textarea, nil: placeholder, classes: ["about"], display_as: :about_html, activator: ".edit-about", html_attrs: {"rows" => 12, "cols" => 140, "spellcheck" => "true"}
  end
